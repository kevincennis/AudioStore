...
export default class AudioStore {
  ...
  constructor( ac, opts = {} ) {
    Object.assign( this, { ac, db: new DB(), duration: 10 } );
  ...
  async getAudioBuffer( name, offset = 0, duration = 10 ) {
    ...
    const metadata = await this[ GET_METADATA ]( name );
